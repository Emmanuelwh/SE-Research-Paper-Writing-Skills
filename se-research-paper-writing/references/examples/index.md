...
Use examples to reuse writing logic, not exact wording.
...
1. Identify the paper type and target section.
2. Read the matching section guide first.
3. Open one examples file only when a concrete pattern is needed.
4. Adapt the role and logic to the user's paper; do not copy claims, numbers, or venue-specific language.
